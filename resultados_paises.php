...
<html>
    ...
    <body>
      ...
      $pais = $_GET["buscar"];
        ...
        //Requiere tres parametros: el objeto 'mysqly_stmt' que devuelve el 'mysqli_prepare', el tipo de dato que devolverá 's' si es string o 'i' si es integer, y la variable
